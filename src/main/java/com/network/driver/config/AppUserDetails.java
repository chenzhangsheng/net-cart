...
public class AppUserDetails implements UserDetails {
    ...
    public AppUserDetails(String userid, String name, Collection<? extends GrantedAuthority> authorities) {
        super();
        this.userid = userid;
        this.username = name;
    ...
    public String toString() {
        return "UserDetails [userid=" + userid + ", name=" + username + ", authorities=" + roles.toString() + ", " +
